$(document).ready(function () {
    ...
    if (loggedInUser) {
        ...
        userLink.parentElement.innerHTML = `<a class="username" href="user.html">Hi, ${loggedInUser}</a>`;
    }
});
document.addEventListener("DOMContentLoaded", () => {
    const loggedInUser = localStorage.getItem("username");
    if (loggedInUser) {
        document.querySelector("#navbar .fa-user").parentElement.innerHTML = `<a class="username" href="user.html">Hi, ${loggedInUser}</a>`;
    }
});